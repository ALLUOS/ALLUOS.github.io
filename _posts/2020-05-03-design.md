...
Moreover, given a reward, a hint of the key to escape, of completing each step successfully in the story, users easily keep motivated. It is largely agreed that reward is an important role in terms of creating motivation(Baranek 1996). 
