...
_How it should be:_ It should be easy to run the bot on your pc or on a server.
_Solution:_ An detailed instruction has been written for both processes. They can be found in the readme file and here.
