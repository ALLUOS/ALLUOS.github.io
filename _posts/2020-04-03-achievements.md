...
The last major consideration is that achievements might be effective only at boosting extrinsic motivation, i.e. motivation to get the achievements, rather than increase the more important intrinsic motivation, i.e. the motivation to actually learn from the gamified educational resource (Mekler et al., 2017). For us it could mean that we motivate the students to mechanically earn the achievements rather than learn and reflect on their study experience.
...
On the other hand, although achievements in most applications target single user’s purposes, the question remains for our specific goal, if achievements for single users and too much comparison of individual performances could interfere with the original idea of the application to be a group learning experience in which users support each other. 
In this sense, a group achievement to show how far this specific group has come already in its learning progress would be a possible future step. This could reinforce the group feeling and commitment and maybe even encourage groups to plan and regularly schedule further common sessions.
