...
There is still room for improvement in the story pipeline, which would make the game more engaging. To apply the different story branches, we first calculate group score and divide it into 3 categories. To categorize the score, we calculate how many mistakes the group makes in total and normalize that score out of 4. Given score 1 out of 4, we provide story branch one. With score 2 or 3 out of 4, we go to branch 2 of the story. And finally with score 4 out of 4 we follow the story branch 3.
