...
1. Adaptive modules problems
2. A paradigm shift to player self-regulation
3. The *path* features
4. Adaptive data
5. Closing remarks
...
1. Motivation
2. Sentence correction task
3. Vocabulary guessing task
...
<h2><span class="section">Third semester - Adaptive module weaknesses led to player self-regulation approach</span></h2>
...
The original adaptive module consisted of two main parts: adaptivity of the task difficulties based on user proficiency data (developed in [semester two]({{ "" | absolute_url }}/2021/04/02/implementation.html#adaptive)) and the self-regulatory element (developed in [semester three]({{ "" | absolute_url }}/2021/02/03/adaptive.html#third)).
