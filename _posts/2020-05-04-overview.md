...
### Semester Two
In the second semester of the project we altered our original organizational approach to foster additional idea-generation for the
purposes for the purposes of developing new features and addressing organizational problems which precipitated during the first semester.

##### Organization and Timeline
As mentioned, we faced difficulties fostering inter-group collaboration during the first semester due to the rigid tripartite
stucture we adoped to organize ourselves around the concept-development and startup task groups. To address these concerns and
organize ourselves more thematicaly around specific task groups, we implemented several 'task forces' which rested atop the
preexisting group structure and aimed to allow more-fluid communication between members devoted to the design and development of
a specific application feature. The newly-introduced sub-groups were determined based on the primary functional goals of the second
semester and were as follows.

1. Achievements. The achievements task force developed a new gamified achievement system for the application. Their work is documented in the [achievements]({{ "" | absolute_url }}/2020/04/03/achievements.html) section.
2. Storytelling. The storytelling task force developed a more immersive storyline for the application and developed accompanying media. Their work is documented in the [storytelling]({{ "" | absolute_url }}/2020/04/02/storytelling.html) section.
3. Adaptive Module. The adaptive module task force developed a path selection module integration with additional data collection for adaptivity and performance evaluation. Their work is documented in the [adaptive module]({{ "" | absolute_url }}/2020/04/01/adaptive.html) section.

The above group concept and accompanying task groups were brainstormed in a pseudo-agile development workflow. For a more complete
visualization of the project schedule during the second semester please refer to the [Project Timeline]({{ "" | absolute_url }}/assets/pdfs/timeline2.pdf).
...
[Project Timeline S1](https://github.com/ALLUOS/ALLUOS.github.io/raw/master/assets/pdfs/timeline.pdf)
